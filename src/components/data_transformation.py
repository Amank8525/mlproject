...
class DataTransformation:
    ...
    def initiate_data_transformation(self, train_path, test_path):
        try:
            ...
            logging.info("Read data from train and test path")
            logging.info("Obtain preprocessor object")

            preprocessoing_obj = self.get_data_transformer_object()
            ...
            input_feature_test_arr=preprocessoing_obj.transform(input_feature_test_df)
